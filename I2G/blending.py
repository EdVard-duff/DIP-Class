...
def blend_src2dst(src,dst):
    root = 'I2G/'
    filename_src = root + src + '.jpg'
    filename_dst = root + dst + '.jpg'
    ...
    return img_src, img_dst, img_dst_src_grad, img_dst_mix_grad, img_dst_mono_grad
...
if __name__=='__main__':
    img_src, img_dst, img_dst_src_grad, img_dst_mix_grad, img_dst_mono_grad = blend_src2dst('man7','man0')
